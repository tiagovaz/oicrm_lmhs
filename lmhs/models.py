...
#    cote_auteur = models.ForeignKey('Auteur', related_name='cote')
    ...
    en_collection = models.TextField(blank=True)
    ...
    no_page = models.TextField(blank=True)
    no_volume = models.TextField(blank=True)
    ...
    source_per = models.TextField(blank=True, null=True)
